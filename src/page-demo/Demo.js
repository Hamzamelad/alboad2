...
class Demo extends Component {
    render() {
        return ( <
            ...
            a href = "/" >
            <
            img src = "/assets/images/logo/logo-all-dark.png"
            alt = "Trydo Images" / >
            <
            /a> <
            /div> <
            ...
            <
            a href = "https://themeforest.net/checkout/from_item/25457315?license=regular"
            target = "_blank"
            className = "rn-button-style--2 btn-solid" > BUY Now < /a> <
            a href = "#demo"
            className = "rn-button-style--2 btn-border rn-btn-dark border-opacity-half" > View Demos < /a> <
            /div> <
            /div> <
            /div> <
            /div> <
            ...
            <
            div className = "fullscreen empty-div gradient-overlay" > < /div> { /* End Banner Area  */ }
            ...
            TabPanel className = "row" > {
                singleDemo.map((value, index) => (
                    ...
                    <
                    img src = {
                        `/assets/images/preview/${value.imageUrl}`
                    }
                    ...
                    p className = "info" > {
                        ...
                        value.label ? < div className = "label-new" > < span > {
                            value.label
                        } < /span></div > : ''
                    } <
                    /a> <
            ...
            <
            h2 className = "theme-gradient" > < span > Awesome Feature < /span></h
            2 >
            <
            p className = "text-white" > Trydo are designed
            for everyone.It doesn’ t matter
            if you’ re a React < br / > Guru or just a complete beginner. < /p> <
            /div> <
            /div> <
            /div>

            <
            div className = "row" > { /* Start Single Feature  */ } {
            ...
            p > Trydo Page speed is so faster and takes byte times
            for load each page.It 's is very easy to use, loads faster and provides better performance for your
            wedsite. < /p> <
            /div> <
            /div>
            ...
            <
            img src = "/assets/images/icons/wave-icon.png"
            alt = "Wave Images" / >
            <
            /div> <
            /div>
            ...
            p > Trydo site works seamlessly on any device without a single compromise, will always looks cool and great on any mobile device or browsers.Its easily adapt your content
            for mobile, tablet and so on. < /p> <
            /div> <
            ...
            div className = "icon" >
            <
            img src = "/assets/images/icons/tablet.png"
            alt = "icon Images" / >
            <
            /div> <
            h6 > Tablet < /h6> <
            ...
            div className = "icon" >
            <
            img src = "/assets/images/icons/desktop.png"
            alt = "icon Images" / >
            <
            /div> <
            h6 > Desktop < /h6> <
            /div> <
            /div> <
            p className = "subtitle" > -Separate Options
            for Each Screen Size < /p> <
            /div> <
            /div> <
            /div> <
            /div> <
            /div> { /* End Responsive Device Area  */ }
            ...
            /h2> <
            p > Check out our FAQ section to see
            if we can help. < /p> <
            /div> <
            ...
            AccordionItemPanel >
            <
            p > Welcome to TryDO React Creative Agency, React Portfolio and Corporate Multi Purpose Template Built With React JS.NO jQuery!.It works too much faster loading speed and you can works too much comfortability.Trydo create your website so much faster, use to use and Well Documented Codes
            for your customization. < /p> <
            /AccordionItemPanel> <
            /AccordionItem>
            ...
            AccordionItemPanel >
            <
            p > You can run trydo easily.First You 'll need to have node and npm on your machine.
            So Please open your command prompt then check your node - v and npm - v Version.Goes To Your your command prompt : then First : < strong > yarn install < /strong></p >
            <
            ...
            <
            /p> <
            p > First Step(replace your choose demo page) : Example: import Demo form './home/MainDemo'
            Instead of './home/PortfolioLanding' < /p> <
            p > Example: < a className = "theme-gradient"
            href = "https://www.dropbox.com/s/ysornwsweh836wi/change-home-page.png?dl=0" > https: //www.dropbox.com/s/ysornwsweh836wi/change-home-page.png?dl=0</a></p>
            <
            /div> <
            /AccordionItemPanel> <
            /AccordionItem>
            ...
            <
            p >
            After purchasing the product need you any support you can be share with us with sending mail to < a className = "theme-gradient"
            href = "mailto:rainbowit10@gmail.com" > rainbowit10 @gmail.com < /a>. <
            /p> <
            /AccordionItemPanel> <
            /AccordionItem>
            ...
            You can be get update
            for unlimited times.Our dedicated team works
            for update. <
            /p> <
            /AccordionItemPanel> <
            /AccordionItem>
            ...
            className = "feather feather-book" > < path d = "M4 19.5A2.5 2.5 0 0 1 6.5 17H20" > < /path><path d="M6.5 2H20v20H6.5A2.5 2.5 0 0 1 4 19.5v-15A2.5 2.5 0 0 1 6.5 2z"></path > < /svg></div >
            <
            div className = "content" >
            <
            ...
            a target = "_blank"
            href = "#"
            className = "rbt-button rn-button-style--2 rn-btn-small-2 btn-solid-border" > < span className = "button-text" > Online Documentation < /span></a >
            <
            /div> <
            /div> <
            /div>
            ...
            strokeLinecap = "round"
            strokeLinejoin = "round"
            className = "feather feather-headphones" > < path d = "M3 18v-6a9 9 0 0 1 18 0v6" > < /path><path d="M21 19a2 2 0 0 1-2 2h-1a2 2 0 0 1-2-2v-3a2 2 0 0 1 2-2h3zM3 19a2 2 0 0 0 2 2h1a2 2 0 0 0 2-2v-3a2 2 0 0 0-2-2H3z"></path > < /svg> <
            /div> <
            div className = "content" >
            <
            ...
            className = "rbt-button rn-button-style--2 rn-btn-small-2 btn-solid-border" > < span className = "button-text" > Get Support < /span></a >
            <
            ...
            <
            img src = "assets/images/bg/gallery.png"
            alt = "Gallery Images" / >
            <
            /div> <
            /div> <
            ...
            p > The product is of good quality and easy to use, We are also the author on Envato and our requirement is very high, Affordable and excellent... < /p> <
            ...
            <
            h5 > Design Quality < /h5> <
            p > The configuration of the contact form was problematic, but the support of
            ...
            p > Excellent design template and easy to customize
            if you know React.Good value. < /p> <
            div className = "rating" >
            <
            img src = "/assets/images/icons/rating.png"
            alt = "Rating Images" / >
            ...
            p > Perfectly support.Well deserved 5 star
            for code and design quality. < /p> <
            div className = "rating" >
            <
            img src = "/assets/images/icons/rating.png"
            alt = "Rating Images" / >
            ...
            Thanks a lot...I will keep buying your products...amazing work...bug free...
            thanks a lot... < /p> <
            div className = "rating" >
            <
            img src = "assets/images/icons/rating.png"
            ...
            target = "_blank"
            href = "https://themeforest.net/checkout/from_item/25457315?license=regular" > < span > Purchase Now < /span></a >
            <
            /div> <
            /div> <
            /div> <
            ...
            /div> { /* End Preview Main Wrapper */ } { /* Start Back To Top */ } <
            div className = "backto-top" >
            <
            ScrollToTop showUnder = {
                160
            } >
            <
            FiArrowUp / >
